<form name="permissionsform"
	action="?sid={SID}&page={PAGE}&action=setpermissions" method="post">
...
<tr>
	<td class="gen">Show images with permission refused:</td>
	<td class="gen"><!-- BEGIN switch ACCESSRESTRICTED -->
	{SHOWREFUSED_YES} {SHOWREFUSED_NO} <!-- END switch ACCESSRESTRICTED -->
	<!-- BEGIN switch NOT_ACCESSRESTRICTED --> <i>This option is only
	available for pages with access restriction</i> <!-- END switch NOT_ACCESSRESTRICTED -->
	</td>
</tr>
<tr>
	<td colspan="2" align="center" class="table"><input type="submit"
		value="Change Permissions" class="mainoption" /> &nbsp;&nbsp;<input
