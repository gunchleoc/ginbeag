...
<form name="site" action="{ACTIONVARS}" method="post">
	...
	<div class="contentsection">
		<fieldset>
			...
			<div class="leftalign" style="width:45% !important; padding-right:2%;">
				<label for="spam_wordssubject">Subject Line</label>
				<br /><textarea id="spamwords_subject" name="spamwords_subject" rows="20" cols="40">{SPAMWORDS_SUBJECT}</textarea>
			...
			<div class="leftalign" style="width:45% !important; padding-right:2%;">
				<label for="spamwords_content">Message Content</label>
				<br /><textarea id="spamwords_content" name="spamwords_content" rows="20" cols="40">{SPAMWORDS_CONTENT}</textarea>
