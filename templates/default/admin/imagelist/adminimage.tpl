...
<div class="smalltext">
	...
	<a href="{IMAGEPATH}" target=_blank><img src="{THUMBNAILPATH}" alt="{IMAGEFILE}" width="{WIDTH}" height="{HEIGHT}" /></a>
	<!-- END switch THUMBNAIL -->
	<!-- BEGIN switch NO_THUMBNAIL -->
	<img src="{IMAGEPATH}" width="{WIDTH}" height="{HEIGHT}" alt="{IMAGEFILE}" width="{WIDTH}" height="{HEIGHT}" />
	<!-- END switch NO_THUMBNAIL -->
	<!-- END switch IMAGE -->
	<!-- BEGIN switch NO_IMAGE -->
	<p class="highlight">File <i>{IMAGEFILE}</i> not found</p>
	<!-- BEGIN switch THUMBNAIL -->
	<br />&nbsp;<br /><img src="{THUMBNAILPATH}"  alt="Thumbnail for {IMAGEFILE}" width="{WIDTH}" height="{HEIGHT}" />
	<!-- END switch THUMBNAIL -->
	<!-- END switch NO_IMAGE -->
