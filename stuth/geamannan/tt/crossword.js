...
function getClue(wordArray) { return wordArray[2]; }

function getXPos(wordArray) { return wordArray[3]; }

function getYPos(wordArray) { return wordArray[4]; }

function isSolved(wordArray) { return wordArray[5]; }
