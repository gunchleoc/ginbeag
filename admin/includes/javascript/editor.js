...
$(document).ready(
    function () {
        ...
        function addlistenersSaveDialog()
        {
            ...
            /* save and collapse */
            $("#{JSID}saveandcollapsebutton").click(
                function () {
                    disableElements(elements);
                    $("#{JSID}status").html("Saving now ... ");
                    var savestatus="";
