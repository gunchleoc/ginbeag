...
{
	global $db;
  $sql=updatefield(PAGES_TABLE,"title_page",$db->setstring($title_page),"page_id='".$db->setinteger($page_id)."'");
  
  if($sql)
  {
    $sql= updatefield(PAGES_TABLE,"title_navigator",$db->setstring($title_navigator),"page_id='".$db->setinteger($page_id)."'");
  }
  return $sql;
}
...
{
	global $db;
  updatefield(PAGETYPES_TABLE,"allow_root",$db->setinteger($allowroot),"type_key='".$db->setstring($pagetype)."'");
  updatefield(PAGETYPES_TABLE,"allow_simplemenu",$db->setinteger($allowsimplemenu),"type_key='".$db->setstring($pagetype)."'");
}
...
function updateeditdata($page_id, $sid)
{
  ...
  updatefield(PAGES_TABLE,"editdate",$now,"page_id='".$db->setinteger($page_id)."'");
  updatefield(PAGES_TABLE,"editor_id",getsiduser($sid),"page_id='".$db->setinteger($page_id)."'");
}
...
function updatecopyright($page_id,$copyright,$imagecopyright,$permission)
{
	global $db;
  $page_id=$db->setinteger($page_id);
  updatefield(PAGES_TABLE,"copyright",$db->setstring($copyright),"page_id='".$page_id."'");
  updatefield(PAGES_TABLE,"image_copyright",$db->setstring($imagecopyright),"page_id='".$page_id."'");
  updatefield(PAGES_TABLE,"permission",$db->setinteger($permission),"page_id='".$page_id."'");
...
{
	global $db;
  deleteentry(RESTRICTEDPAGES_TABLE,"masterpage ='".$db->setinteger($page_id)."'");
  deleteentry(RESTRICTEDPAGESACCESS_TABLE,"page_id ='".$db->setinteger($page_id)."'");
  rebuildaccessrestrictionindex();
}
